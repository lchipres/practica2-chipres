(function() {
  var Promise, _, ansi_up, chalk, clone, displayFlags, displayRetriesRemaining, get, getMsgByType, isCypressErr, isProduction, listItems, log, logException, strip, throwErr, trimMultipleNewLines, twoOrMoreNewLinesRe, warnIfExplicitCiBuildId, warning,
  ...
  getMsgByType = function(type, arg1, arg2) {
    ...
    switch (type) {
      ...
      case "INVALID_CYPRESS_ENV":
        return "We have detected unknown or unsupported CYPRESS_ENV value\n\n  " + (chalk.yellow(arg1)) + "\n\nPlease do not modify CYPRESS_ENV value.";
      ...
      case "CDP_COULD_NOT_CONNECT":
        return "Cypress failed to make a connection to the Chrome DevTools Protocol after retrying for 5 seconds.\n\nThis usually indicates there was a problem opening the Chrome browser.\n\nThe CDP port requested was " + (chalk.yellow(arg1)) + ".\n\nError details:\n\n" + arg2.stack;
    }
  };
