(function() {
  var CdpAutomation, EE, Promise, Windows, _, appData, debug, getAutomation, menu, net, plugins, profileCleaner, savedState, tryToCall;
  ...
  getAutomation = function(win) {
    var sendDebuggerCommand;
    sendDebuggerCommand = function(message, data) {
      return tryToCall(win, Promise.method(function() {
        return win.webContents["debugger"].sendCommand(message, data);
      }));
    };
    return CdpAutomation(sendDebuggerCommand);
  };
  ...
  module.exports = {
    ...
    _launch: function(win, url, options) {
      ...
      return Promise["try"]((function(_this) {
        return function() {
          return _this._attachDebugger(win.webContents);
        };
        ...
        return function() {
          return _this._enableDebugger(win.webContents);
        };
      })(this))["return"](win);
    },
    ...
    _enableDebugger: function(webContents) {
      debug("debugger: enable Console and Network");
      return Promise.join(webContents["debugger"].sendCommand("Console.enable"), webContents["debugger"].sendCommand("Network.enable"));
    },
    ...
    _clearCache: function(webContents) {
      ...
      return Promise.fromCallback((function(_this) {
        return function(cb) {
          return webContents.session.clearCache(cb);
        };
      })(this));
    },
