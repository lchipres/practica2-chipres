  ...
  module.exports = {
    ...
    init: function(config, options) {
      ...
      return new Promise(function(resolve, reject) {
        var childArguments, childIndexFilename, childOptions, handleError, handler, i, ipc, killPluginsProcess, len;
    ...
    execute: function() {
      ...
      debug.apply(null, ["execute plugin event '" + event + "' Node '" + process.version + "' with args: %o %o %o"].concat(slice.call(args)));
