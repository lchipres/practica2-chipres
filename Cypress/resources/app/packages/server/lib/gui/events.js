(function() {
  var Project, Updater, Windows, _, api, auth, browsers, chromePolicyCheck, debug, dialog, ensureUrl, errors, handleEvent, ipc, konfig, logs, open, openProject, pkg, shell, user;
  ...
  handleEvent = function(options, bus, event, id, type, arg) {
    var apiUrl, onBus, onError, onFocusTests, onMessage, onSettingsChanged, onSpecChanged, onWarning, send, sendErr, sendNull, sendResponse;
