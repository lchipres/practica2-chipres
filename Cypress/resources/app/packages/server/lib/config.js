(function() {
  var CONFIG_DEFAULTS, CYPRESS_ENV_PREFIX, CYPRESS_ENV_PREFIX_LENGTH, CYPRESS_RESERVED_ENV_VARS, CYPRESS_SPECIAL_ENV_VARS, Promise, _, breakingConfigKeys, coerce, configKeys, convertRelativeToAbsolutePaths, dashesOrUnderscoresRe, debug, deepDiff, errors, everythingAfterFirstEqualRe, findSystemNode, folders, fs, hideSpecialVals, isCypressEnvLike, keys, oneOrMoreSpacesRe, origin, path, pathHelpers, removeEnvPrefix, scaffold, settings, toWords, v, validate, validateFile, validateNoBreakingConfig, validationRules;
  ...
  CYPRESS_RESERVED_ENV_VARS = ["CYPRESS_ENV"];
  ...
  module.exports = {
    ...
    isValidCypressEnvValue: function(value) {
      var names;
    ...
    mergeDefaults: function(config, options) {
      ...
      if (!this.isValidCypressEnvValue(config.cypressEnv)) {
