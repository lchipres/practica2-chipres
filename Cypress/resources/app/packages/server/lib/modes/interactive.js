(function() {
  var EE, Events, Promise, Windows, _, app, cyIcons, errors, image, isDev, logs, menu, os, savedState, user;
  ...
  module.exports = {
    ...
    ready: function(options) {
      ...
      return savedState(projectRoot, false).then(function(state) {
        return state.get();
      }).then((function(_this) {
        return function(state) {
          return Windows.open(projectRoot, _this.getWindowArgs(state, options)).then(function(win) {
