(function() {
  ...
  throwIfNoProjectId = function(projectId, configFile) {
    if (!projectId) {
  ...
  usedTestsMessage = function(limit, phrase) {
    if (_.isFinite(limit)) {
  ...
  createRun = Promise.method(function(options) {
