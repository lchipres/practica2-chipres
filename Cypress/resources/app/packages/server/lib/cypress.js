(function() {
  var Promise, _, cp, debug, exit, exit0, exitErr, os, path, warning;
  ...
  exitErr = function(err) {
    ...
    return require("./errors").logException(err).then(function() {
      return exit(1);
    });
  };
  ...
  module.exports = {
    ...
    startInMode: function(mode, options) {
      ...
      switch (mode) {
        ...
        case "smokeTest":
          return this.runElectron(mode, options).then((function(_this) {
